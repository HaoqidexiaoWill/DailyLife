...
if __name__ == '__main__':
    ...
    parser.add_argument('model_save', help='save location of model')
    ...
    with open(os.path.join(args.model_save, 'config.json')) as f:
    ...
    model.load_best_save(directory=args.model_save)
