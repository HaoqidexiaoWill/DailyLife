...
def get_args():
    ...
    parser.add_argument('--epoch', help='max epoch to run for', default=800, type=int)
    ...
    #parser.add_argument('--lr', help='learning rate', default=float(0.0001),type=float)
    ...
    parser.add_argument('-n', '--nick', help='nickname for model', default='1层att_concat1335_his_800')
