...
class Turn:
    ...
    def annotate_raw(cls, raw):
        ...
        if raw['turn_label'] == ['slot_dontknow', 'value_dontknow']:
            raw['turn_label'] = [['slot_dontknow', 'value_dontknow']]
    ...
    def extract_ontology(self):
        ...
        for t in self.iter_turns():
            for s, v in t.turn_label:
                #print("turn_label",t.turn_label)
                
                #if s =="taxi-leaveAt" or v =="bus-Leaveat":
    ...
    def evaluate_preds(self, preds):
        ...
        for d in self.dialogues:
            ...
            for t in d.turns:
                ...
                # print(gold_recovered,'#',pred_recovered)
                #print(gold_request,"#",pred_request)
                i += 1
