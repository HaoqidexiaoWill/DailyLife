...
parser.add_argument('-train_anno', default="./data/data_raw/train.jsonl",
                    help="Path to the training annotated data")
parser.add_argument('-valid_anno', default="./data/data_raw/dev.jsonl",
                    help="Path to the validation annotated data")
parser.add_argument('-test_anno', default="./data/data_raw/test.jsonl",
                    help="Path to the test annotated data")

parser.add_argument('-save_data', default="./data/data_anno",
...
def main():
    ...
    torch.save(table.IO.TableDataset.save_vocab(fields),open(os.path.join(opt.save_data, 'vocab.pt'), 'wb'))
    train.fields = []
    valid.fields = []
